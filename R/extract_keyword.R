...
#' @param nbefore The number of words to include before the keyword. The
#'   default is 0.
#' @param nafter The number of words to include after the keyword. The default
#'   is 0.
#'
#' @return A data frame with three variables: \code{PDF_file}, \code{PDF_page},
#'   and \code{Keyword_extract}.
#' @export
#'
#' @examples
#' \dontrun{
...
extract_keyword <- function(file, keyword, nbefore = 0L, nafter = 0L) {
  ...
  stopifnot(!missing(file), !missing(keyword))
